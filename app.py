...
# CSS
app.static('/assets/css/fontawesome-all.min.css',
           './res/assets/css/fontawesome-all.min.css')
app.static('/assets/css/main.css', './res/assets/css/main.css')
app.static('/assets/css/noscript.css', './res/assets/css/noscript.css')

# JS
app.static('/assets/js/breakpoints.min.js',
           './res/assets/js/breakpoints.min.js')
...
# Highlight js
app.static('/assets/thirdparty/highlight/highlight.pack.js',
           './res/assets/thirdparty/highlight/highlight.pack.js')
app.static('/assets/thirdparty/highlight/styles/dracula.css',
...
async def index(request: Request):
    logger.info(
        f"Client at {request.ip}:{request.port} requested {request.url}.")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Simple website server.')
    parser.add_argument('--port', dest='port', action='store', default=8000,
                        type=int,
